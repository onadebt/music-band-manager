    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.
                authorizeHttpRequests( x -> x
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/artists/unlink/**/**").hasAuthority(MANAGER_SCOPE)
                        .requestMatchers(HttpMethod.PATCH, "/api/artists/link/**/**").hasAuthority(MANAGER_SCOPE)

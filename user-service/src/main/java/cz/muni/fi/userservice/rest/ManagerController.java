...
public class ManagerController {
    ...
    public ResponseEntity<ManagerDto> register(@NotNull  @Valid @RequestBody ManagerDto managerDTO) {
    ...
    public ResponseEntity<ManagerDto> getById(@NotNull @PathVariable Long id) {
    ...
    public ResponseEntity<ManagerDto> updateBands(@NotNull @PathVariable Long managerId, @NotNull @RequestBody Set<Long> bandIds) {
    ...
    public ResponseEntity<List<ManagerDto>> getManagersByBandIds(@NotNull @RequestParam Set<Long> bandIds) {
    ...
    public ResponseEntity<ManagerDto> update(@NotNull @PathVariable Long id, @NotNull @RequestBody ManagerUpdateDto updateDto) {

    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.
                authorizeHttpRequests( x -> x
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/bands").hasAuthority(GENERAL_SCOPE)
                        .requestMatchers(HttpMethod.DELETE, "/api/bands/{bandId}/members/**").hasAuthority(GENERAL_SCOPE)
                        .requestMatchers(HttpMethod.PATCH, "/api/bands/{bandId}/members/**").hasAuthority(MANAGER_SCOPE)
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/bands/offers/{offerId}/accept").hasAuthority(MUSICIAN_SCOPE)
                        .requestMatchers(HttpMethod.POST, "/api/bands/offers/{offerId}/reject").hasAuthority(MUSICIAN_SCOPE)
                        .requestMatchers(HttpMethod.POST, "/api/bands/offers/{offerId}/revokes").hasAuthority(MANAGER_SCOPE)
